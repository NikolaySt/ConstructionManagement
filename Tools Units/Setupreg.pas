...
Uses MyConst,	CodePassword, RegisterProgram, Password, DlgMess, KprStroi;
...
//TODO: Disable register
    ...
    Else
    	DlgKooperacia.ActiveTimer := True;
    End;
  End;
	If DlgKooperacia.ActiveTimer Then DlgKooperacia.TimerOut.Enabled := True;
end;

Procedure TCustomOptions.RegisterProgram;
Begin
	If DlgRegProgram.ShowModal <> mrOK Then DlgKooperacia.ActiveTimer := True;
End;
	...
	With SecProgram Do Begin
{
      ...
      If Result = C_NotError Then Begin
        ...
        Case Result Of
        	C_NotError: ;
          C_Error_NotCompare:
          	If Not DlgPass.Execute Then	DlgKooperacia.ActiveTimer := True;
        Else
					DlgKooperacia.ActiveTimer := True;
        End;
{
    	End
      Else DlgKooperacia.ActiveTimer := True;
    End
    Else DlgKooperacia.ActiveTimer := True;
}    
  End;
